...
- When you need to test a colleague's PR or pull a remote branch without disrupting your local dev server: Fetch latest remote references
...
- When running benchmark tests, LLM coding agents, or temporary refactors without polluting your branch list:  Create an ephemeral detached worktree
...
```
- Worktree Management & Housekeeping
...
-. Productivity Aliases (Add to ~/.gitconfig)
