...
const functionsIn_1 = __importDefault(require("lodash/functionsIn"));
...
function ToText(markup) {
    ...
    (0, extend_1.default)(this, markup || {});
    (0, bindAll_1.default)(this, (0, functionsIn_1.default)(this));
}
// Break line
...
ToText.prototype.glossary = function (glossary) {
    ...
    (0, each_1.default)(glossary, (entry) => {
...
ToText.prototype._summaryArticles = function (articles, level) {
    ...
    (0, each_1.default)(articles, (article) => {
...
ToText.prototype.summary = function (summary) {
    ...
    content += that.onSection();
    (0, each_1.default)(summary.parts, (part, i) => {
